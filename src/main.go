...
func main() {
	...
	dialInfo, err := mgo.ParseURL("mongodb://Purevbadar:Badar.purev112@pdrmongodb-shard-00-00-zchft.mongodb.net:27017,pdrmongodb-shard-00-01-zchft.mongodb.net:27017,pdrmongodb-shard-00-02-zchft.mongodb.net:27017/admin?replicaSet=pdrMongoDb-shard-0")
